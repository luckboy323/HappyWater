package com.alex.business.wepay.utils;
...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	static{
		...
		setAppID(resource.getString("public.appId"));
		setAppSecret(resource.getString("public.appSecret"));
		setPartner(resource.getString("public.partner"));
		setPartnerKey(resource.getString("public.partnerKey"));
	}
	...
	public static void setPartner(String partner) {
		WxPayConfigure.partner = partner;
	}
	...
	public static void setPartnerKey(String partnerKey) {
		WxPayConfigure.partnerKey = partnerKey;
	}
	...
	public static void setAppSecret(String appSecret) {
		WxPayConfigure.appSecret = appSecret;
	}
